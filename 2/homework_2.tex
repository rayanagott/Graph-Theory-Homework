...
We can calculate the sum of all degrees by:
$$\sigma \deg(v) = n(n-1) + n(n) + n(n+1) = n((n-1)+n+(n+1)) = n(3n) = 3n^2.$$
$3n^2$ must be even because each edge contributes 2 to the sum of degrees. 
